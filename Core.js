...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./Assets/pic10.jpg'), `${watermark}`, `${BotName}`, "2347069096801@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
if (antiVirtex) {
    ...
    if (AntiLink) {
        ...
        kice = m.sender
        await A17.groupParticipantsUpdate(m.chat, [kice], 'remove')
        A17.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} He/She has been removed for sending Instagram link in this group! No promotion is allowed!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await A17.groupParticipantsUpdate(m.chat, [kice], 'remove')
        A17.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} He/She has been removed for sending Facebook link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await A17.groupParticipantsUpdate(m.chat, [kice], 'remove')
        A17.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} He/She has been removed for sending Telegram link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await A17.groupParticipantsUpdate(m.chat, [kice], 'remove')
        A17.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} He/She has been removed for sending Tiktok link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await A17.groupParticipantsUpdate(m.chat, [kice], 'remove')
        A17.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} He/She has been removed for sending Twitter link in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await A17.groupParticipantsUpdate(m.chat, [kice], 'remove')
        A17.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} He/She has been removed for sending links in this group!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
            ...
            if (isMedia && m.msg.fileSha256 && (m.msg.fileSha256.toString('base64') in global.db.sticker)) {
              ...
              const textImg = (teks) => {
                ...
                const fgi = {
                  ...
                  { remoteJid: "2347069096801-1613049930@g.us" } : {}) 
                               },
                  message: { 
                                "videoMessage": { 
                                "title": `NASS-WORKS`,
...
const ftroli = {
  ...
  "message": {
  "groupInviteMessage": {
  "groupJid": "2347069096801-1616169743@g.us",
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    Hello ${pushname} dear 👋. I am ${global.BotName}, a bot developed by: NASS-WORKS to take your WhatsApp usage into next level.
    ...
    ©️ *${global.BotName}* All Rights Reserved by: *Nass*
    `
...
case 'support': case 'supportgc':
    ...
    reply(`*My developer's group*: https://chat.whatsapp.com/LIriWFvmyyp9RakyOh1zyV`)
    break

case 'repo': case 'botrepo':
    
    reply(`*You wanna get my source code🧐* - ask *Nass* if he's willing to give you... bwahahaha`)
    break
...
let mentioned = participants.map(v => v.jid)
 ...
 case 'resetlinkgc':
    ...
    case 'group': case 'grup': {
     ...
     sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./Assets/pic7.jpg'), `${global.packname}`, `${global.BotName}`, "2347069096801@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
     } else if (sizny > 20) {
     await A17.groupAcceptInvite(vcc).then(async(res) => replay(jsonformat(res))).catch(_ => _)
     replay("Joined !")
     } else {
...
case 'public': {
 ...
 if (!isCreator) return reply(mess.botowner)
 A17.public = false
 reply('Only Nass can use me now!')
...
case 'music': case 'play': case 'song': case 'ytplay': {
 ...
 caption: `「  _NASS-WORKS Y-tube Player 3.0_  」
...
*Url :* ${anu.url}`,
 ...
 let buttonMessage = {
 image: { url: anu.thumbnail },
 caption: `「  _NASS-WORKS Youtube Downloader 2.0_  」
...
*Url :* ${anu.url}`,
 ...
 await A17.sendMessage(from, {document: fs.readFileSync(ytmp3play2.path),fileName:'NASS-WORKS_YTmp3_Downloader.mp3',mimetype: 'audio/mpeg',}, {quoted:m})
 }
 break
 ...
 A17.sendMessage(from, {video:{url:ytmp4play2.videoUrl}, mimetype:"video/mp4", caption:'Downloaded by *NASS-WORKS MD*',}, {quoted:m})
 }
 break
...
case 'charactercheck':
 ...
 case 'dare':
    ...
    if (isBanChat) return reply(mess.bangc)
	 ...
	 "Go outside and scream I love he / she use voice note for evidence",
	 "Make a voice note of yourself with another accent",
	 "Make Nass your bf throughout the day if your a girl",
	 "Exchange your name with anyone in the group for 2 hour",
         ...
         "record ur voice that read *Nass is a genius*",
         "prank chat ex and say *i love u, please come back.* without saying dare!",
         "chat to contact wa in the order according to your battery %, then tell him *i am lucky to hv you!*",
         "change the name to *I am a fool* for 5 hours",
         "post I'm weak for 24 hours in your status",
         "Use Ronaldo's photo for 3 days as your new DP",
         ...
         "say i love the bot owner Nass through voice note",
...
case 'truth':
    ...
    if (isBanChat) return reply(mess.bangc)
		 ...
		 "If u meet a genie what will be yo wish yo me?",
	         "Hav u ever asked for S3x?",
		 "Were u the most ticklish?",
		 "have you ever used makeup in a clowny way?",
                 ...
                 "do you love the bot creator Nass?",
                 ...
                 "do you play pubg, if you then you better try Free fire"
             ]
...
case 'help': case 'h': case 'menu':  case 'Nass': case 'allmenu': case 'listmenu':{
    if (isBan) return reply(mess.banned)	 			
    if (isBanChat) return reply(mess.bangc)
      
const helpmenu = `Sup *${pushname}* Dear...!! ,

│───────────────────────│
┠⬡│▸ I am *NASS-WORKS*, 
 a Bot Developed by *Nass*.
│───────────────────────│
│╭────────────────···▸
┠─────═[ *⚠️⚠️⚠️* ]═────
│╰────────────────·⚠️▸
│╭────────────────·⚠️▸
┴│▸ ⚠️⚠️⚠️⚠️⚠️⚠️
⬡│▸ *WARNING* : Don't Dm bot
┬│▸  _~USE IT ONLY IN GROUP~_
│╰────────────────···▸
┠───═[ *BOT INFO* ]═──▸
│╭────────────────···▸
┴│▸ 
...
⬡│▸ " *${prefix}<Command name>* ".
⬡│▸
⬡│▸ 🌹 To get Support Group link "*${prefix}Support*".
⬡│▸
